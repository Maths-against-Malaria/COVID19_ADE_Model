...
# Probability of showing symptoms or dying when partially immuned (PI)
fPI_sick = 0.50
fPI_dead = 0.02
...
ODEName = {'S^NV': dSNV, 'S^U': dSU, 'S^V': dSV, 'S^NI': dSNI, 'S^PI': dSPI, 'S^ADE': dSADE, \
           'E^U': dEU, 'E^V': dEV, 'E^NI': dENI, 'E^PI': dEPI, 'E^ADE': dEADE, \
           'P^U': dPU, 'P^V': dPV, 'P^NI': dPNI, 'P^PI': dPPI, 'P^ADE': dPADE, \
           'I^U+': dIUplus, 'I^U-': dIUminus, 'I^V': dIV, 'I^NI': dINI, 'I^PI': dIPI, 'I^ADE': dIADE, 'I^IV': dIIV,
           'I^Itilde': dIItilde, 'I^Istar': dIIstar, \
           'L^U+': dLUplus, 'L^U-': dLUminus, 'L^V': dLV, 'L^NI': dLNI, 'L^PI': dLPI, 'L^ADE': dLADE, 'L^IV': dLIV,
           'L^Itilde': dLItilde, \
           'L^Istar': dLIstar, 'L^LV': dLLV, 'L^Ltilde': dLLtilde, 'L^Lstar': dLLstar, \
           'D': dD, \
...
df.to_csv("COVID_19_vaccine_simulation_Germany_Coverage_vs_ADE_Level.csv")
